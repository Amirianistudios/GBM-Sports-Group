...
export const ka: Dict = {
  ...
  'nav.representation': 'წარმომადგენლობა',
  'nav.signout': 'გასვლა',

  'search.button': 'ძებნა',
  'search.placeholder': 'მოძებნე მოთამაშე სახელით…',
  'search.empty': 'მოთამაშე ვერ მოიძებნა',
  'search.hint': 'პირდაპირ გადადი ბაზის ნებისმიერ მოთამაშესთან.',

  'discover.intro':
    'დალაგებულია GBM-ის შესაძლებლობების მოდელით — ასაკი, სამიზნე ბაზრები, რეალისტური ღირებულებები, წუთები და საკონტრაქტო ფანჯრები. ყველა ქულა თავად იხსნება მოთამაშის პროფილზე.',
  'discover.markets.gbm': 'GBM-ის ბაზრები',
  'discover.markets.all': 'ყველგან',
  'discover.top': 'მთავარი შესაძლებლობები',
  'discover.top.sub': 'ყველაზე მაღალი GBM-შესაბამისობა ახლა',
  'discover.emerging': 'აღმავალი ტალანტები',
  'discover.emerging.sub': 'კიდევ 24 წლამდე მოთამაშეები €5მ-მდე, ზემოთ ნაჩვენებთა გარდა',
  'discover.contract': 'საკონტრაქტო ფანჯარა იხურება',
  'discover.contract.sub': 'კიდევ 30 წლამდე მოთამაშეები კონტრაქტის ბოლო 18 თვეში',
  'discover.newest': 'ახალი GBM-ის ბაზრებზე',
  'discover.newest.sub': 'ბოლოს დამატებული მოთამაშეები სამიზნე ბაზრებიდან',
  'discover.openAll': 'გახსენი სრული ბაზა ფილტრებით →',
  'discover.empty': 'ამ ბაზარზე ჯერ არაფერია — ბაზა იზრდება სამიზნე ბაზრების იმპორტთან ერთად.',
  'discover.presets': 'სწრაფი დაწყება',
  'discover.preset.u21': 'U21, ღირებულება იზრდება',
  'discover.preset.contract': 'კონტრაქტი მთავრდება, 28-მდე',
  'discover.preset.noagency': 'სააგენტო არ არის მითითებული',
  'discover.preset.minutes': 'ახალგაზრდები, თამაშობენ ყოველ კვირას',
  'nav.menu': 'მენიუ',
